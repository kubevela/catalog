...
vectorController: {
	name: "vector-controller"
	type: "webservice"
	dependsOn: [o11yNamespace.name, vectorControllerExtraResources.name]
	properties: {
...
vectorControllerExtraResources: {
	name: "vector-controller-extra-resources"
	type: "k8s-objects"
	dependsOn: [o11yNamespace.name]
	properties: objects: [
		_vectorControllerConfigMap,
		_vectorConfigCRD,
	]
}
...
_vectorControllerConfigMap: {
	apiVersion: "v1"
	kind:       "ConfigMap"
	metadata: name: "vector-controller"
	data: {}
}
