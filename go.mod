module github.com/oam-dev/catalog
...
require (
	...
	github.com/grpc-ecosystem/grpc-gateway v2.16.0 // indirect
  github.com/grpc-ecosystem/grpc-gateway/v2 v2.16.0 // indirect
	...
	github.com/kubevela/pkg v0.0.0-20230103022800-b6bdefd2e1de // indirect
	github.com/kubevela/workflow v0.3.5 // indirect
...
replace sigs.k8s.io/apiserver-network-proxy/konnectivity-client => sigs.k8s.io/apiserver-network-proxy/konnectivity-client v0.28.0
