...
// The OAM spec calls for float64 quantities in some cases, but this
...
type VolumeResource struct {
	...
	// Use +kubebuilder:default marker to default AccessMode to RW
...
type ContainerPort struct {
	...
	// Use +kubebuilder:default marker to default Protocol to TCP
...
type Container struct {
	...
	// Ideally the key within this secret would be configurable, but
...
type StatefulSetWorkloadSpec struct {
	...
	// TODO(QWQ): Depending on the nature of the OAM, it should be the default here and specified in the servicetrait
